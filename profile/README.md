...
Sensor fusion is method which uses a set of  algorithms to correlate obtained from the above sensor sources to produce a enhanced single data source which represents the process environment.
